  ...
  return (
    <div className="w-full h-1/3">
      <div className="h-full w-full relative">
        <div className="h-[16rem] w-full bg-black opacity-40 absolute z-10"></div>
        <Image
          src={banner}
          alt="banner"
        ...
        <div className="flex justify-between items-center">
          <div className="relative flex py-6">
            <Image
              src={avatar}
              alt="avatar"
              className="object-cover z-30 rounded-full h-[130px] bg-red-200 w-[130px] absolute left-4 -top-12"
            />
            <div className="ml-40">
